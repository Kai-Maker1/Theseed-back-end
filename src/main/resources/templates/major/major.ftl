    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            ...
            <div class="layui-carousel" id="test1">
                <div carousel-item>
                    <div><p class="layui-bg-green demo-carousel">演示说明</p></div>
                    <div><p class="layui-bg-red demo-carousel">在编辑器中可以执行模块相关的一切代码</p></div>
       ...
       /* layer.msg('Hello World');*/
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'username', title: '专业/班级名', width:80}
