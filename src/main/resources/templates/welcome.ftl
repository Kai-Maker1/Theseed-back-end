...
/*border: 1px solid gainsboro;*/
        #container3{width: 300px;height: 300px;float: left;}
        #container1{width: 380px;height: 300px;margin-left: 10px;}
        #container4{width: 380px;height: 300px;margin-left:10px;margin-top:20px;}
        #container2{width: 300px;height: 300px;float: left;margin-top:20px;}
        .div-left{border:1px solid #000;float:left;margin-left: 5%;}
        .div-right{border:1px solid #000;float:right;margin-left: 5%;}
    </style>
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md6">
            <div class="layui-card">
                <div class="layui-card-header">用户访问总量</div>
        ...
        <div class="layui-col-md6">
            <div class="layui-card">
                <div class="layui-card-header">男性用户总量</div>
                <div class="layui-card-body">
                    <h2>250</h2>
                </div>
            </div>
        ...
        <div class="layui-col-md6">
            <div class="layui-card">
                <div class="layui-card-header">女性用户总量</div>
                <div class="layui-card-body">
                    <h2>1750</h2>
                </div>
            </div>
...
<div style="width: 100%;height: 100%;">
    <div class="layui-col-md6" style="width: 70%;height: 100%;float: left;">
        <div class="layui-card" id="container3" style="width:100% ;height: ;" ></div>
        <div class="layui-card" id="container2" style="width: 100%;"></div>
    </div>
    <div class="layui-col-md6" style="width: 30%;height: 100%;float: right;">
        <div class="layui-card" id="container1" ></div>
        <div class="layui-card" id="container4" ></div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var charts = [];
    //
    var myChart = echarts.init(dom1,'light');
    option = {
        title : {
            text: '男女用户访问比例/周',
    ...
    charts.push(myChart);
    //
    var myChart = echarts.init(dom3,'light');
    option = {
        title : {
            text: '用户访问量和流失量',
            /* subtext: '纯属虚构'*/
        ...
        series : [
            {
                name:'访问量',
                type:'bar',
                data:[20, 49, 70, 232, 256, 267, 136, 162, 326, 20, 64, 33],
                markPoint : {
                    data : [
                        {type : 'max', name: '最大值'},
                        {type : 'min', name: '最小值'}
            ...
            },
            {
                name:'流失量',
                type:'bar',
                data:[26, 59, 90, 64, 28, 70, 16, 12, 48, 18, 6, 2],
                markPoint : {
                    data : [
                        {name : '年最高', value : 90, xAxis: 2, yAxis: 90},
    ...
    //
    myChart = echarts.init(dom4,'light');
    option = {
        title: {
             text: '课程学习用户分布'
        },
    ...
    charts.push(myChart);
    //
    myChart = echarts.init(dom2,'light');
